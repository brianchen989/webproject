...
<header><!-- logo-->
    ...
    <section class="sec1">
        <img id="raccoon1" class="clickable" src="{{{{ url_for('static', filename='image/浣熊3.png') }}}}" alt="浣熊1" />
    </section>
    <h1>這裡是logo</h1>
    <nav><!-- 導覽列-->
        <ul><!--無數字列表 -->
            <li><a class="nav-link" href="{{{{ url_for('index') }}}}#17goals">介紹</a></li><!--跳至第三區 -->
            <li><a class="nav-link" href="{{{{ url_for('index') }}}}#quoteBlock" style="margin-top: 80px;">冷知識</a></li>
            <li><a class="nav-link" href="{{{{ url_for('index') }}}}#small_game">小遊戲</a></li>
        </ul>
    </nav>
</header>
...
<footer>
    <p>0908107363</p>
    <p>brianchen989@gmail.com </p>
    <p>https://github.com/brianchen989</p>
</footer><!-- 頁尾-->
{{% endblock %}}
"""
...
print("Regenerated 17 template files with header and footer successfully.")
